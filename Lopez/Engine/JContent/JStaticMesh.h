...
public:
	...
	JStaticMesh(XMFLOAT3 center = XMFLOAT3(0.f, 0.f, 0.f), float width = 1.f, float height = 1.f, bool bViewport, const char* name = nullptr);
...
protected:
	...
	std::vector<XMFLOAT3>			m_BiTengents{};
